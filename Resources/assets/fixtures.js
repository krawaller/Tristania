    var fixtures = {
        ...
        selectedvideos: [{
            title: "Karmøygeddon - Year of the Rat",
            id: "wSQ9TnIFthA"
        }],
        officialvideos: [{
        ...
        news: [{
            date: "2010-07-16",
            title: "Welcome!",
            content: "<p>This message will be displayed until the app has downloaded news from Tristania.com, which will happen automagically when you have internet connection.</p>"
        }]
    };